...
J = 5
beta = c(0, 7, 3)
s0 = c(1.3, 0,0) # variance qui sont des parametres de nuisances censés être stric positifs 
...
# N2 = ""
# ...
# level_boot si level = TRUE
# level_asym si level = TRUE
# power_boot si power = TRUE
# power_asym si power = TRUE

#resultat = createResultatList(N_grid, B, K, alpha_grid)#, level, power) # à compléter pour level et power
